...
† Added to complete regional balance; URL verified live, first priced at panel activation. ‡ At pilot the city page lacked a McChicken average and a named store page was planned; on activation verification (2026-07-02) the city page carried one, so the city page is pinned like all other metros.
